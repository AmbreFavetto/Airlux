const QUERY = {
  ...
  CREATE_SCENARIO_SOUS_SCENARIO: 'INSERT INTO scenarioSousScenario(scenario_id, sousScenario_id, id) VALUES (?, ?, ?)',
  UPDATE_SCENARIO_SOUS_SCENARIO: 'UPDATE scenarioSousScenario SET scenario_id = ?, sousScenario_id = ? WHERE id = ?',
