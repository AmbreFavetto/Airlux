...
const deviceCreateSchema = Joi.object().keys({
  ...
  category: Joi.string().required().valid("lamp", "lamp_rgb", "blind", "radiator", "air_conditioning"),
  room_id: Joi.string().required()
});

const deviceUpdateSchema = Joi.object().keys({
  name: Joi.string().optional(),
  category: Joi.string().optional().valid("lamp", "lamp_rgb", "blind", "radiator", "air_conditioning"),
