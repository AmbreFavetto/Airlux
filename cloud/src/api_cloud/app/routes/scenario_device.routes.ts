...
import { getScenariosDevices, createScenarioDevice, getScenarioDevice, deleteScenarioDevice, updateScenarioDevice } from '../controllers/scenario_device.controller';
