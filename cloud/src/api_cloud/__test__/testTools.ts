...
const QUERY = {
    ...
    CREATE_SOUS_SCENARIO: 'INSERT INTO sousScenario(device_id, sous_scenario_id, action) VALUES ("123", "123", "on")',
    DELETE_SOUS_SCENARIOS: 'DELETE FROM sousScenario',
    CREATE_SCENARIO_SOUS_SCENARIO: 'INSERT INTO scenarioSousScenario(scenario_id, sous_scenario_id, id) VALUES ("123", "123", "123")',
